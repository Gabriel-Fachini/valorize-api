...
export const ALL_ROLES: RoleDefinition[] = [
  {
    ...
    permissions: [
      ...
      PERMISSION.VOUCHERS_SEND_TO_USERS,
      ...
      PERMISSION.REDEMPTIONS_VIEW_ALL,
      PERMISSION.REDEMPTIONS_VIEW_DETAILS,
      PERMISSION.REDEMPTIONS_UPDATE_STATUS,
      PERMISSION.REDEMPTIONS_CANCEL,
    ],
  },
  {
